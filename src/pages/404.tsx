      ...
      <Container>
        <div className="mt-16 md:mt-44">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col items-center self-center px-12 mt-6 md:mt-0 md:block">
              <h1 className="my-4 font-bold font-header text-8xl">404</h1>
              <h2 className="mb-10 text-2xl font-bold text-center font-header md:text-left">
              ...
              <Link
                to="/"
                className="inline-block border-2 btn border-yellowSecondary"
              >
                HOME
              </Link>
            </div>
