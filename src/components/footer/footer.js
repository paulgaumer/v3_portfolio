...
const Footer = () => {
  return (
    <footer className="pt-12 pb-10 mt-16 text-white bg-bluePrimary">
      <div className="mb-10 text-center">
        <h4 className="antialiased text-yellowPrimary">Next step?</h4>
        <h3 className="mt-2 text-3xl uppercase">Let's work together!</h3>
      </div>
      <div className="flex space-x-16 mb-15">
        <div className="w-1/2 md:text-lg">
          <p className="mb-5">
            If you'd like to talk about a project or need advice about product
            and ideation , simply drop me a message. I'm currently available for
            development projects, entrepreneurial gigs or events.
          </p>
          <div>
            ...
            <ul className="flex space-x-6">
              ...
              <li>
                ...
                >
                  <img src={twitter} alt="twitter icon" className="w-8 h-10" />
                </a>
              </li>
            </ul>
          </div>
